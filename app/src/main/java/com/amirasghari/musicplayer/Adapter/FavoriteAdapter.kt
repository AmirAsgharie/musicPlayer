...
class FavoriteAdapter(val context: Context , val data:ArrayList<AudioModel> , private val listener:MusicListener): RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder>() {

    inner class FavoriteViewHolder(val binding:MusicRowBinding):RecyclerView.ViewHolder(binding.root){
