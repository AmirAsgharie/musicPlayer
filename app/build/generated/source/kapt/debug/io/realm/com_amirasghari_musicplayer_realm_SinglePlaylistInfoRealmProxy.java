...
public class com_amirasghari_musicplayer_realm_SinglePlaylistInfoRealmProxy extends com.amirasghari.musicplayer.realm.SinglePlaylistInfo
    ...
    static final class SinglePlaylistInfoColumnInfo extends ColumnInfo {
        ...
        SinglePlaylistInfoColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.musicName_PlayListColKey = addColumnDetails("musicName_PlayList", "musicName_PlayList", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.musicName_PlayListColKey = src.musicName_PlayListColKey;
    ...
    @Override
    @SuppressWarnings("cast")
    public String realmGet$musicName_PlayList() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.musicName_PlayListColKey);
    }

    @Override
    public void realmSet$musicName_PlayList(String value) {
        if (proxyState.isUnderConstruction()) {
        ...
        proxyState.getRealm$realm().checkIfValid();
        throw new io.realm.exceptions.RealmException("Primary key field 'musicName_PlayList' cannot be changed after object was created.");
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        ...
        builder.addPersistedProperty(NO_ALIAS, "musicName_PlayList", RealmFieldType.STRING, Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
    ...
    public static com.amirasghari.musicplayer.realm.SinglePlaylistInfo createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (update) {
            ...
            long pkColumnKey = columnInfo.musicName_PlayListColKey;
            long objKey = Table.NO_MATCH;
            if (json.isNull("musicName_PlayList")) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
                objKey = table.findFirstString(pkColumnKey, json.getString("musicName_PlayList"));
            }
        ...
        if (obj == null) {
            if (json.has("musicName_PlayList")) {
                if (json.isNull("musicName_PlayList")) {
                    ...
                    obj = (io.realm.com_amirasghari_musicplayer_realm_SinglePlaylistInfoRealmProxy) realm.createObjectInternal(com.amirasghari.musicplayer.realm.SinglePlaylistInfo.class, json.getString("musicName_PlayList"), true, excludeFields);
                }
            } else {
                throw new IllegalArgumentException("JSON object doesn't have the primary key field 'musicName_PlayList'.");
            }
        }
    ...
    public static com.amirasghari.musicplayer.realm.SinglePlaylistInfo createUsingJsonStream(Realm realm, JsonReader reader)
        ...
        while (reader.hasNext()) {
            ...
            } else if (name.equals("musicName_PlayList")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$musicName_PlayList((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$musicName_PlayList(null);
                }
    ...
    public static com.amirasghari.musicplayer.realm.SinglePlaylistInfo copyOrUpdate(Realm realm, SinglePlaylistInfoColumnInfo columnInfo, com.amirasghari.musicplayer.realm.SinglePlaylistInfo object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (canUpdate) {
            Table table = realm.getTable(com.amirasghari.musicplayer.realm.SinglePlaylistInfo.class);
            long pkColumnKey = columnInfo.musicName_PlayListColKey;
            String value = ((com_amirasghari_musicplayer_realm_SinglePlaylistInfoRealmProxyInterface) object).realmGet$musicName_PlayList();
            long objKey = Table.NO_MATCH;
            if (value == null) {
                objKey = table.findFirstNull(pkColumnKey);
            } else {
    ...
    public static com.amirasghari.musicplayer.realm.SinglePlaylistInfo copy(Realm realm, SinglePlaylistInfoColumnInfo columnInfo, com.amirasghari.musicplayer.realm.SinglePlaylistInfo newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addString(columnInfo.musicName_PlayListColKey, unmanagedSource.realmGet$musicName_PlayList());
    ...
    public static long insert(Realm realm, com.amirasghari.musicplayer.realm.SinglePlaylistInfo object, Map<RealmModel,Long> cache) {
        ...
        SinglePlaylistInfoColumnInfo columnInfo = (SinglePlaylistInfoColumnInfo) realm.getSchema().getColumnInfo(com.amirasghari.musicplayer.realm.SinglePlaylistInfo.class);
        long pkColumnKey = columnInfo.musicName_PlayListColKey;
        String primaryKeyValue = ((com_amirasghari_musicplayer_realm_SinglePlaylistInfoRealmProxyInterface) object).realmGet$musicName_PlayList();
        long objKey = Table.NO_MATCH;
    ...
    public static com.amirasghari.musicplayer.realm.SinglePlaylistInfo createDetachedCopy(com.amirasghari.musicplayer.realm.SinglePlaylistInfo realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        ...
        unmanagedCopy.realmSet$musicName_PlayList(realmSource.realmGet$musicName_PlayList());
    ...
    static com.amirasghari.musicplayer.realm.SinglePlaylistInfo update(Realm realm, SinglePlaylistInfoColumnInfo columnInfo, com.amirasghari.musicplayer.realm.SinglePlaylistInfo realmObject, com.amirasghari.musicplayer.realm.SinglePlaylistInfo newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addString(columnInfo.musicName_PlayListColKey, realmObjectSource.realmGet$musicName_PlayList());
    ...
    public String toString() {
        ...
        stringBuilder.append("}");
        stringBuilder.append(",");
        stringBuilder.append("{musicName_PlayList:");
        stringBuilder.append(realmGet$musicName_PlayList() != null ? realmGet$musicName_PlayList() : "null");
        stringBuilder.append("}");
        stringBuilder.append(",");
