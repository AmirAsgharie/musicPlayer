...
public class FragmentShowMusicBindingImpl extends FragmentShowMusicBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.controlBtn, 9);
        sViewsWithIds.put(R.id.controlMusicImg, 10);
    }
    // views
    @NonNull
    ...
    public FragmentShowMusicBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private FragmentShowMusicBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
